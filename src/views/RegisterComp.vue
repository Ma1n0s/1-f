          ...
          <div class="container max-w-md mx-auto p-4 pt-6 md:p-6 lg:p-12">
            <div class="card bg-gray-200 shadow-md rounded">
              ...
              <div class="card-body p-4">
                <div class="mb-4">
                  <label for="username" class="block mb-2 text-sm">Фамилия Имя(Отчество при наличии)</label>
                ...
                <div class="mb-4">
                  <label for="org-name" class="block mb-2 text-sm">Название организации</label>
                  <input v-model="data.name_comp"
                    type="text"
                    id="org-name"
                ...
                <div class="mb-4">
                  <label for="inn" class="block mb-2 text-sm">ИНН организации</label>
                  <input v-model="data.inn_comp"
                    type="text"
                    id="inn"
                    placeholder="ИНН"
                    required
                ...
                <div class="mb-4">
                  <label for="email" class="block mb-2 text-sm">Электронная почта</label>
                ...
                <div class="mb-4">
                  ...
                  <label for="newsletter" class="text-sm">Подключить рассылку информации по электронной почте.</label>
                </div>
                <div class="mb-4">
                  <input type="checkbox" id="terms" class="mr-2" />
                  <label for="terms" class="text-sm">Я прочитал(а) правила сайта и согласен(сна) с ними</label>
                </div>
                <div class="mb-4">
                  <button type="submit" class="bg-black text-white font-bold py-2 px-4 rounded">Зарегистрироваться</button>
                </div>
...
<style scoped>
/* Добавьте любые необходимые стили здесь */
</style>
